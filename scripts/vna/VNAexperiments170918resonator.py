...
vna = instruments.create('VNA','Agilent_E5071C', address='TCPIP0::172.28.140.252::inst0::INSTR') # VNA1
...
# c12 = (r'Z:\_Data\Smeagol\Data\vna\Parker\\C12\\',r'C:\Data\vna\Parker\C12_resonator_with_screw.h5')
# pnc2a = (r'Z:\_Data\Smeagol\Data\vna\Parker\pnc2a\\', r'C:\Data\vna\Parker\pnc2a_power_sweep_resonator_with_screw.h5')
...
if 0: # standard power sweep
    title = 'powers_' 
    powers = np.linspace(-70, 0, 10)
    myfile, h5file = pnc2a
    power_sweep_data = VNA_functions.power_sweep(vna,powers,fridge=smeagol,
                                                 folder=myfile,
                                                 PULSE_TUBE='ON',
                                                 avgs_start=100,avgs_stop=20,
                                                 NUM_POINTS=1000,atten=atten,
