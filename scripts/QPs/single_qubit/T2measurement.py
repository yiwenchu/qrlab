...
class T2Measurement(Measurement1D):
    ...
    def __init__(self, qubit_info, delays, detune=0, echotype=ECHO_NONE, necho=1, double_freq=False, laser_power = None, Qswitch_infoA=None, Qswitch_infoB=None, **kwargs):
