...
class Rabi_QP(Measurement1D):

    def __init__(self, qubit_info, amps, QP_delay, inj_len, update=False, seq=None, r_axis=0, fix_phase=True, fix_period=None, repeat_pulse=1, postseq=None, fit_type=FIT_AMP,  **kwargs):
        ...
        super(Rabi_QP, self).__init__(len(amps), infos=qubit_info, **kwargs)
