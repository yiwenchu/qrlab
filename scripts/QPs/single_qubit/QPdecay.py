...
class QPdecay(Measurement1D):
    ...
    def __init__(self, qubit_info, T1_delays, rep_time, meas_per_reptime=1, meas_per_QPinj=None, fit_start='auto', fit_end=None, vg=0.04, ve=7.21, eff_T1_delay=2000.0, inj_len=10e3, extraT1_delays=None, **kwargs):
        ...
        if self.extraT1_delays is not None:
            super(QPdecay, self).__init__(len(self.QP_delays)+len(self.extraT1_delays), infos=qubit_info, **kwargs)
        else:
    ...
    def generate(self):
        ...
        for j, qdt in enumerate(self.qdt_delays):
            ...
            s.append(r(np.pi, 0))
            if inj_len < 20000:
                s.append(Constant(inj_len, 1, chan="3m1"))
                ...
                s.append(Constant(inj_len-n_10us_pulse*10000, 1, chan="3m1"))
...
#                s.append(Constant(250, 0, chan=4))
                ...
                s.append(Repeat(Constant(10000, 1, chan="3m1"), n_10us_pulse))
                s.append(Constant(self.rep_time-5000-n_10us_pulse*10000, 1, chan="3m1"))
