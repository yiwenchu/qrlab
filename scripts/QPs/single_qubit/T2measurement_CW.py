...
class T2Measurement_CW(Measurement1D):

    def __init__(self, qubit_info, delays, laser_voltage, atten = None, detune=0, echotype=ECHO_NONE,
        ...
        super(T2Measurement_CW, self).__init__(len(delays), infos=qubit_info, **kwargs)
        ...
        self.data.set_attrs(
            ...
            laser_voltage = self.laser_voltage,
