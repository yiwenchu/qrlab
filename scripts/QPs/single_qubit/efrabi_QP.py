...
class EFRabi_QP(Measurement1D):

    def __init__(self, ge_info, ef_info, areas, QP_delay, first_pi=True, second_pi=True,
        ...
        super(EFRabi_QP, self).__init__(len(areas), infos=(ge_info, ef_info), **kwargs)
...
#            ]))
            ...
            s.append(self.ge_info.rotate(np.pi, 0))
