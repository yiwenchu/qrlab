...
class Rabi_laser(Measurement1D):

    def __init__(self, qubit_info, amps, update=False, seq=None, laser_delay = None, laser_plen = None, r_axis=0, fix_phase=True, fix_period=None, repeat_pulse=1, postseq=None, fit_type=FIT_AMP, **kwargs):
        ...
        super(Rabi_laser, self).__init__(len(amps), infos=qubit_info, **kwargs)
    ...
    def generate(self):
        ...
        for i, amp in enumerate(self.amps):
            ...
            s.append(Delay(self.laser_delay*10e9))
